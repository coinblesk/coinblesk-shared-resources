 ...
 * @author draft
 */
public class UserAccountStatusTO {
    ...
    public UserAccountStatusTO success(final boolean success) {
        this.success = success;
        return this;
    }
    
    public UserAccountStatusTO setSuccess() {
        return success(true);
    }
    ...
    public UserAccountStatusTO reason(final Reason reason) {
    ...
    public UserAccountStatusTO message(final String message) {
